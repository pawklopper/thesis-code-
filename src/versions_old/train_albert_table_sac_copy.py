...
if __name__ == "__main__":
    with warnings.catch_warnings():
        ...
        model_name = "sac_albert_table_test"
        base_log_dir = "runs_albert_table_test"
        render = False

        goal_list = [(0.0, -2.0)]  # single fixed goal for focused testing
